...
struct Parser {
    ...
    static Op fnOp(const string& name, bool& ok) {
        ...
        if (name == "sinh") return Op::SINH;
        if (name == "cosh") return Op::COSH;
        if (name == "tanh") return Op::TANH;
        if (name == "atanh" || name == "arctanh") return Op::ATANH;
        if (name == "sec") return Op::SEC;
        if (name == "csc") return Op::CSC;
        if (name == "cot") return Op::COT;
