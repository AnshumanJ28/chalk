...
static string fnName(Op op) {
    switch (op) {
        ...
        case Op::SEC: return "sec"; case Op::CSC: return "csc"; case Op::COT: return "cot";
...
static string latexFnName(Op op) {
    switch (op) {
        ...
        case Op::TANH: return "\\tanh";
        case Op::ATANH: return "\\tanh^{-1}";
        case Op::SEC: return "\\sec";
        case Op::CSC: return "\\csc";
        case Op::COT: return "\\cot";
...
static void toLatexRec(const ExprPtr& e, ostringstream& out, int parentPrec) {
    switch (e->op) {
        ...
        case Op::SINH: case Op::COSH: case Op::TANH: case Op::ATANH:
